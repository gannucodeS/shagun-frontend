...
function initGallery() {
  ...
  const galleryData = {
    all: [
      { src: 'https://i.postimg.cc/9Fwmhfb0/pic17.jpg', label: 'Royal Mandap', cat: 'Wedding' },
      { src: 'https://i.postimg.cc/4NHfg3Pd/pic16.jpg', label: 'Bridal Portrait', cat: 'Wedding' },
      { src: 'https://i.postimg.cc/SNYShKdL/pic20.jpg', label: 'Haldi Ceremony', cat: 'Haldi' },
      { src: 'https://i.postimg.cc/4NHfg3Pm/pic9-(1).jpg', label: 'Mehendi Night', cat: 'Mehendi' },
      { src: 'https://i.postimg.cc/ZYMb2N8q/pic4.jpg', label: 'Grand Reception', cat: 'Reception' },
      { src: 'https://i.postimg.cc/fTSzNbCX/pic19.jpg', label: 'Wedding Decor', cat: 'Wedding' },
      { src: 'https://i.postimg.cc/Fskr4Kpx/resize.jpg', label: 'Groom Arrival', cat: 'Wedding' },
    ],
    wedding: [],
    haldi: [],
    mehendi: [],
